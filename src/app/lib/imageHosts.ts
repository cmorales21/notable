...
// should render `unoptimized` — the image loads directly from origin, which
...
export const OPTIMIZED_HOSTS: ReadonlySet<string> = new Set([
  // App assets
...
export function shouldOptimize(src: string): boolean {
  try {
